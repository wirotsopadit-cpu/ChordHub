...
export const MOCK_SONGS: Song[] = [
  {
    ...
    difficulty: 'easy',
    youtubeId: 'Vn_VfG93V2w',
    coverImage: 'https://img.youtube.com/vi/Vn_VfG93V2w/hqdefault.jpg',
    viewCount: 14520,
    status: 'published',
    createdBy: 'system',
...
[C] [D] [G]`
  },
  {
    ...
    difficulty: 'medium',
    youtubeId: 'UePqm2y9Kzg',
    coverImage: 'https://img.youtube.com/vi/UePqm2y9Kzg/hqdefault.jpg',
    viewCount: 28940,
    status: 'published',
    createdBy: 'system',
...
{eov}`
  },
  {
    ...
    difficulty: 'medium',
    youtubeId: 'R21U3sJm7eE',
    coverImage: 'https://img.youtube.com/vi/R21U3sJm7eE/hqdefault.jpg',
    viewCount: 39500,
    status: 'published',
    createdBy: 'system',
...
{eoc}`
  },
  {
    ...
    tags: ['อินดี้ป็อป', 'เพลงวัยรุ่น', 'เพลงเพราะ'],
    difficulty: 'easy',
    youtubeId: 'F16aI6y3pWc',
    coverImage: 'https://img.youtube.com/vi/F16aI6y3pWc/hqdefault.jpg',
    viewCount: 52100,
    status: 'published',
    createdBy: 'system',
...
function mapSong(id: string, d: Record<string, any>): Song {
  return {
    ...
    coverImage: d.coverImage || (d.youtubeId ? `https://img.youtube.com/vi/${d.youtubeId}/hqdefault.jpg` : undefined),
