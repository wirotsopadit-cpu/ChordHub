  ...
  return (
    <html lang="th" className="dark scroll-smooth">
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Prompt:wght@300;400;500;600;700&family=JetBrains+Mono:wght@400;500;600&display=swap"
          rel="stylesheet"
        />
      </head>
        ...
        <header className="sticky top-0 z-50 border-b border-zinc-800/80 bg-zinc-950/80 backdrop-blur-xl supports-[backdrop-filter]:bg-zinc-950/60 no-print">
          <div className="mx-auto flex h-14 max-w-5xl items-center justify-between px-4 sm:px-6">
            ...
            <nav className="flex items-center gap-3 sm:gap-4 text-sm font-medium text-zinc-400">
              <a href="/" className="hover:text-emerald-400 transition">หน้าแรก</a>
              <a href="/search" className="hover:text-emerald-400 transition flex items-center gap-1">
                <span>ค้นหาเพลง</span>
              </a>
